...
def load_ratings_data(num_users:int, num_files:int)->np.ndarray:
    file_name='ratings'
...
def load_cmu_data(num_users:int, num_files:int)->np.ndarray:
    file_name="CMU_huge"
...
def load_synthetic_data(num_users:int, num_files:int, user:int=0)->np.ndarray:
    file_name=f'synthetic_user_{user}.npy'
